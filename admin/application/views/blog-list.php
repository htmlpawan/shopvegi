...
<head>
	<title>KT Export - Blog List</title>
	<meta charset="utf-8">
						...
						<div class="panel-body">
						 <table class="table table-striped table-bordered" id="productList">
							...
							<tbody>
										...
										{
											echo "<tr><td>".$no++."</td><td>".$row['title']."</td><td style='width: 20%;'><img style='width: 50%;' src='".base_url()."uploads/blogs/".$row['image']."'></td><td>";
											echo "<a href='editblog/".$row['id']."' class='btn btn-success'><i class='fa fa-pencil-square-o'></i></a></td><td><button onclick='productdelete(".$row['id'].")' class='btn btn-danger'><i class='fa fa-trash-o'></i></button></td></tr>";
										} 
										?>
